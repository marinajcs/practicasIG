...
void printHelp()
{
  ...
  printf("1, 2: enciende/apaga la fuente de luz 1 y 2, respectivamente\n");
  printf("\n Escape: Salir");
  printf("\n\n\n");
}
...
float dCamara = 10;
bool ilum = true;
std::vector<float> viewPos = {0.0, 0.0, 0.0};
