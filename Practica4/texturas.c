...
void Dibuja(void)
{
  ...
  //______________________PRÁCTICA-4_____________________
  ...
  glPushMatrix();
  bigdodge->materialSettings(0, mat_dif); //specular only
  bigdodge->materialSettings(1, mat_spec);
  bigdodge->materialSettings(2, none);
  ...
  glPushMatrix();
  bigdodge->materialSettings(0, mat_dif); //ambient and diffuse
  bigdodge->materialSettings(1, none);
  bigdodge->materialSettings(2, mat_amb);
  glPopMatrix();
