...
void printHelp()
{
  ...
  printf("p: visualizar los modelos como puntos.\nl: visualizar los modelos como líneas.\nf: visualizar los modelos como objetos sólidos y rellenos.\n");
  printf("i: encender/apagar la fuente de luz.\nA: (des)activar el movimiento automático por defecto de la grúa.\n");
  printf("B: modifica ángulo del brazo de la grúa para ir rotándolo en sentido antihorario.\nb: modifica el ángulo del brazo de la grúa para ir rotándolo en sentido horario.\n");
  printf("M: modifica el ángulo del gancho de la grúa para ir rotándolo en sentido horario.\nm: modifica el ángulo del gancho de la grúa para ir rotándolo en sentido antihorario.\n");
  printf("C: modifica  la longitud de la cuerda de la grúa para ir alargándola.\nc: modifica  la longitud de la cuerda de la grúa para ir acortándola.\n");
  printf("\n Escape: Salir");
  printf("\n\n\n");
}
